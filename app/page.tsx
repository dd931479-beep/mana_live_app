        ...
        {isCounting && (
          ...
          >
            <div style={{ marginBottom: '10px', textAlign: 'center' }}>
              <p style={{ margin: 0, fontSize: '0.9rem', fontWeight: 'bold', whiteSpace: 'nowrap' }}>限定公開中♡</p>
              <p style={{ margin: 0, fontSize: '0.8rem', fontWeight: 'bold', whiteSpace: 'nowrap' }}>まなで検索してね🔎</p>
            </div>
